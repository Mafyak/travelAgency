...
--
-- Name: hotelfeatures; Type: TYPE; Schema: public; Owner: Siarhei_Huba
--

CREATE TYPE public.hotelfeatures AS ENUM (
    'Wi-fi',
    'Pet-friendly',
    'Washer',
    'Free Breakfast',
...
ALTER TYPE public.hotelfeatures OWNER TO "Siarhei_Huba";
...
CREATE TABLE public."Hotel" (
    ...
    name character(30),
    stars smallint,
    website character(30),
    lalitude double precision,
    longitude double precision,
    features public.hotelfeatures
);
...
--
-- Name: test; Type: TABLE; Schema: public; Owner: Siarhei_Huba
--
...
ALTER TABLE public.test OWNER TO "Siarhei_Huba";
